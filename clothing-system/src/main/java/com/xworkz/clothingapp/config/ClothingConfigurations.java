...
public class ClothingConfigurations {

    public ClothingConfigurations(){
        System.out.println("Clothing configurations instance created");
    }
    ...
    public DataSource getDataSource(){
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/cloths");
    ...
    public LocalContainerEntityManagerFactoryBean getLocalContainerEntityManagerFactoryBean(){
        ...
        beanFactory.setPackagesToScan("com.xworkz.clothingapp.entity");

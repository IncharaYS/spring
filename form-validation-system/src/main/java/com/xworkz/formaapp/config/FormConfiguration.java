package com.xworkz.formaapp.config;
...
@Configuration
@ComponentScan(basePackages = "com.xworkz.formaapp")
public class FormConfiguration {
    ...
    public DataSource getDataSource(){
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/forms");
    ...
    public LocalContainerEntityManagerFactoryBean getLocalContainerEntityManagerFactoryBean(){
        ...
        beanFactory.setPackagesToScan("com.xworkz.formaapp.entity");
